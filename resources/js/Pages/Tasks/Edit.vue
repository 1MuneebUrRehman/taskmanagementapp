    ...
    <div class="py-4 lg:py-8 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div class="relative flex items-center space-x-4">
            ...
            <div>
              ...
              <p class="text-sm text-gray-600 dark:text-gray-400">
                {{ isAdvancedMode ?
                  (currentStep === 1 ? 'Update the basic details for your task' :
                      currentStep === 2 ? 'Modify categorization and status' :
                          'Adjust dates and assignments') : 'Update the details for your task' }}
              </p>
            </div>
          </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <InputLabel for="reminder_at" class="text-base font-medium text-gray-900 dark:text-white flex items-center space-x-2 mb-2">
                  <svg class="w-5 h-5 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-5 5v-5zM4.828 7l2.829 2.829A4 4 0 009.071 9H15m0 0a4 4 0 01-4 4H5.929l-2.83 2.828M15 9a4 4 0 014-4H4.929L7.757 2.172" />
                  </svg>
                  <span>Reminder</span>
                </InputLabel>
                <input
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400">Move this task to archive</p>
                  </div>
                </div>
                <Switch
                    id="archived"
          ...
          <div class="flex flex-col sm:flex-row justify-between items-center pt-8 border-t border-gray-200 dark:border-gray-700 space-y-4 sm:space-y-0">
            ...
            <div class="flex items-center space-x-4">
              ...
              >
                ...
                <span>{{ form.processing ? 'Updating Task...' : 'Update Task' }}</span>
              </PrimaryButton>
            </div>
          </div>
      ...
      <div class="mt-6 lg:mt-8 bg-indigo-50 dark:bg-indigo-900/20 backdrop-blur-sm rounded-2xl lg:rounded-3xl p-6 lg:p-8 border border-indigo-200 dark:border-indigo-800">
        <div class="flex items-start space-x-4">
          ...
          <div>
            <h3 class="text-lg font-semibold text-indigo-900 dark:text-indigo-200 mb-3">💡 Tips for Effective Task Management</h3>
            <ul class="text-sm text-indigo-800 dark:text-indigo-300 space-y-2">
              <li class="flex items-start space-x-2">
                ...
                <span>Keep task titles clear and action-oriented</span>
              </li>
              <li class="flex items-start space-x-2">
                <svg class="w-4 h-4 mt-0.5 text-indigo-500" fill="currentColor" viewBox="0 0 20 20">
                  <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                </svg>
                <span>Update due dates regularly to reflect current priorities</span>
              </li>
              <li class="flex items-start space-x-2">
                <svg class="w-4 h-4 mt-0.5 text-indigo-500" fill="currentColor" viewBox="0 0 20 20">
                  <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                </svg>
                <span>Use appropriate priority levels to organize your workflow</span>
              </li>
              <li class="flex items-start space-x-2">
                <svg class="w-4 h-4 mt-0.5 text-indigo-500" fill="currentColor" viewBox="0 0 20 20">
                  <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
